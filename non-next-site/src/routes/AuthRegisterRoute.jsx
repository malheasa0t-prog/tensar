...
/**
 * Renders the customer registration route in the non-Next copy.
 *
 * @returns {JSX.Element}
 */
export default function AuthRegisterRoute() {
  ...
  /**
   * Creates a new customer account using Supabase authentication.
   *
  ...
  async function handleRegister(event) {
    ...
    try {
      ...
      setError(mapRegisterAuthError(submissionError));
      setLoading(false);
      return;
    }
