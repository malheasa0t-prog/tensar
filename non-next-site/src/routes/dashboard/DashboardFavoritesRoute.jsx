...
import styles from "@/app/dashboard/favorites/favoritesPage.module.css";

/**
 * Renders the favorites dashboard route in the non-Next copy.
 *
 * @returns {JSX.Element}
 */
  ...
  if (loading || !hasHydratedFavorites) {
    return (
      <div className="dash-orders-card">
        <div className="dash-loading">جارٍ تحميل المفضلة...</div>
      </div>
    );
  }
      ...
      {favoriteProducts.length === 0 ? (
        <div className="dash-orders-card">
          <div className="dash-empty-orders">
            ...
            لا توجد منتجات محفوظة في المفضلة حاليًا
