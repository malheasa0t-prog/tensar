...
/**
 * Renders the shared deposit request content for both public and dashboard routes.
 *
 * @returns {JSX.Element}
 */
export default function DepositRequestPanel() {
  ...
  useEffect(() => {
    ...
    /**
     * Subscribes to realtime deposit updates after the initial load.
     *
