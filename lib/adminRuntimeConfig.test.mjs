...
test('resolveAdminRuntimeAssetConfig should fail builds when required public keys are missing', () => {
  assert.throws(
    ...
    /Missing required public environment variables for legacy admin asset: NEXT_PUBLIC_SUPABASE_URL, NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY, NEXT_PUBLIC_SUPABASE_ANON_KEY/
  );
});
