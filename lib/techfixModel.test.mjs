...
test("selectFeaturedProducts should skip accessories and sort by newest", () => {
  const products = [
    { id: "1", category_id: "cat-accessories-direct-items", created_at: "2024-01-01", status: "active" },
...
test("selectFeaturedProducts should fall back to active products when catalog is accessories only", () => {
  const products = [
    { id: "1", category_id: "cat-accessories-direct-items", created_at: "2024-02-01", status: "active" },
    { id: "2", category_id: "cat-accessories-direct-items", created_at: "2024-03-01", status: "active" },
  ];
