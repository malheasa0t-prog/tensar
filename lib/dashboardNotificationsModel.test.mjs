...
test("getNotificationLink should route discontinued product notifications to services", () => {
  assert.equal(getNotificationLink({ reference_type: "product", reference_id: "prd-7" }), "/services");
});
