...
test("buildRouteBreadcrumbItems should cover checkout, compare, and subscriptions", () => {
  ...
  assert.deepEqual(buildRouteBreadcrumbItems({ pathname: "/subscriptions" }), [
    { href: "/", label: "الرئيسية" },
    { href: undefined, label: "شحن واشتراكات" },
  ]);
});
