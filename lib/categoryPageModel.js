...
/**
 * Maps a raw product or digital service row to the ProductCard contract.
 *
...
export function mapCategoryProductCard(product, categoryName) {
  if (product._isDigitalService) {
    return {
      ...
      price: product.price,
      discountPrice: null,
      quantity: product.max_qty || 999,
      description: product.description,
      badge: product.speed || product.guarantee || null,
      rating: null,
      reviewCount: null,
      images: product.image ? [product.image] : [],
      icon: categoryName || 'zap',
