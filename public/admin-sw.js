...
const PRECACHE_URLS = [
    ...
    '/css/variables.css?v=20260523-2',
    '/css/base.css?v=20260523-2',
    '/css/utilities.css?v=20260523-2',
    '/css/admin/layout.css?v=20260523-2',
    '/css/admin/components.css?v=20260523-2',
    '/css/admin/responsive.css?v=20260523-2',
    '/css/admin/cards.css',
    ...
    '/js/admin/core.helpers.js?v=20260523-2',
    '/js/admin/global-search.helpers.js?v=20260523-2',
    '/js/admin/global-search.js?v=20260523-2',
    '/js/admin/bulk-actions.helpers.js?v=20260523-2',
    '/js/admin/bulk-actions.js?v=20260523-2',
    '/js/admin/table-enhancements.helpers.js?v=20260523-2',
    '/js/admin/table-enhancements.js?v=20260523-2',
    '/js/admin/admin-shell.helpers.js?v=20260523-2',
    '/js/admin/admin-shell.js?v=20260523-2',
    '/js/admin/session-guard.js?v=20260523-2',
    '/js/admin/dashboard.js?v=20260523-2',
    '/js/admin/orders.js?v=20260523-2',
    '/js/admin/products.js?v=20260523-2',
    '/js/admin/categories.js?v=20260523-2',
    '/js/admin/services.js?v=20260523-2',
    '/js/admin/messages.js?v=20260523-2',
    '/js/admin/notifications.helpers.js?v=20260523-2',
    '/js/admin/notifications.js?v=20260523-2',
    '/js/admin/chats.helpers.js?v=20260523-2',
    '/js/admin/chats.js?v=20260523-2',
    '/js/admin/customers.js?v=20260523-2',
    '/js/admin/coupons.js?v=20260523-2',
    '/js/admin/refunds.js?v=20260523-2',
    '/js/admin/provider-alerts.js?v=20260523-2',
    '/js/admin/platform-updates.js?v=20260523-2',
    '/js/admin/serva-catalog.js?v=20260523-2',
    '/js/admin/sellers.js?v=20260523-2',
    '/js/admin/error-codes.js?v=20260523-2',
    '/js/admin/settings-promo-banners.js?v=20260523-2',
    '/js/admin/settings.js?v=20260523-2',
    '/js/admin/logs.js?v=20260523-2',
    '/js/admin/deposits.js?v=20260523-2',
    '/js/admin/data-engine.js?v=20260523-2',
