const CACHE_NAME = 'tz-admin-shell-20260426-5';
const SYNC_TAG = 'tz-admin-sync';
const PRECACHE_URLS = [
    '/__tz-panel.html?v=20260426-5',
    '/fonts/fonts.css',
    ...
    '/css/admin/chats.css',
    '/admin-config.js?v=20260426-5',
    '/js/admin/bootstrap.js?v=20260426-5',
    '/js/admin/core.js?v=20260426-5',
    '/js/admin/global-search.helpers.js?v=20260426-5',
    '/js/admin/global-search.js?v=20260426-5',
    '/js/admin/bulk-actions.helpers.js?v=20260426-5',
    '/js/admin/bulk-actions.js?v=20260426-5',
    '/js/admin/table-enhancements.helpers.js?v=20260426-5',
    '/js/admin/table-enhancements.js?v=20260426-5',
    '/js/admin/admin-shell.helpers.js?v=20260426-5',
    '/js/admin/admin-shell.js?v=20260426-5',
    '/js/admin/dashboard.js?v=20260426-5',
    '/js/admin/orders.js?v=20260426-5',
    '/js/admin/products.js?v=20260426-5',
    '/js/admin/categories.js?v=20260426-5',
    '/js/admin/services.js?v=20260426-5',
    '/js/admin/messages.js?v=20260426-5',
    '/js/admin/notifications.helpers.js?v=20260426-5',
    '/js/admin/notifications.js?v=20260426-5',
    '/js/admin/chats.helpers.js?v=20260426-5',
    '/js/admin/chats.js?v=20260426-5',
    '/js/admin/customers.js?v=20260426-5',
    '/js/admin/coupons.js?v=20260426-5',
    '/js/admin/settings-promo-banners.js?v=20260426-5',
    '/js/admin/settings.js?v=20260426-5',
    '/js/admin/logs.js?v=20260426-5',
    '/js/admin/deposits.js?v=20260426-5',
    '/js/admin/data-engine.js?v=20260426-5',
