...
(function () {
    ...
    const SECTION_SCRIPT_GROUPS = Object.freeze({
        ...
        orders: [...TABLE_SCRIPT_GROUP, ...BULK_ACTION_SCRIPT_GROUP, 'js/admin/orders.js'],
        'product-orders': [...TABLE_SCRIPT_GROUP, ...BULK_ACTION_SCRIPT_GROUP, 'js/admin/orders.js'],
        'accessory-orders': [...TABLE_SCRIPT_GROUP, ...BULK_ACTION_SCRIPT_GROUP, 'js/admin/orders.js'],
        products: [...TABLE_SCRIPT_GROUP, ...BULK_ACTION_SCRIPT_GROUP, 'js/admin/products.helpers.js', 'js/admin/products.form.js', 'js/admin/products.js'],
        accessories: [...TABLE_SCRIPT_GROUP, 'js/admin/accessories.js'],
        categories: [...TABLE_SCRIPT_GROUP, 'js/admin/categories.js'],
        'main-categories': [...TABLE_SCRIPT_GROUP, 'js/admin/categories.js'],
        subcategories: [...TABLE_SCRIPT_GROUP, 'js/admin/categories.js'],
        services: [...TABLE_SCRIPT_GROUP, ...BULK_ACTION_SCRIPT_GROUP, 'js/admin/services.js'],
        messages: [...TABLE_SCRIPT_GROUP, 'js/admin/messages.js'],
        notifications: ['js/admin/notifications.helpers.js', 'js/admin/notifications.js'],
        chats: ['js/admin/chats.helpers.js', 'js/admin/chats.js'],
        customers: [...TABLE_SCRIPT_GROUP, ...BULK_ACTION_SCRIPT_GROUP, 'js/admin/customers.helpers.js', 'js/admin/customers.js'],
        coupons: [...TABLE_SCRIPT_GROUP, 'js/admin/coupons.js'],
        settings: ['js/admin/settings-promo-banners.js', 'js/admin/settings.js'],
        logs: [...TABLE_SCRIPT_GROUP, 'js/admin/logs.helpers.js', 'js/admin/logs.js'],
        deposits: [...TABLE_SCRIPT_GROUP, 'js/admin/deposits.js'],
